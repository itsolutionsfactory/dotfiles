...
for module in zsh certs hyfetch vim kitty kubectl github-cli gitlab-cli nvm defguard; do
...
for module in zsh nvm certs hyfetch vim kitty kubectl github-cli gitlab-cli defguard; do
