...
for module in zsh certs hyfetch vim kitty kubectl github-cli gitlab-cli nvm claude-code; do
...
for module in zsh nvm certs hyfetch vim kitty kubectl github-cli gitlab-cli claude-code; do
